...
const DietPlanTable = () => {
    ...
    useEffect(() => {
        const fetchDietPlans = async () => {
            try {
                const response = await axios.get('http://172.206.238.50:5000/obtener_elementos_algoritmo', {
                    params: {
                        altura,
                        peso,
    ...
    const handleSaveDiet = async (plan) => {
        try {
            const response = await axios.post(`http://172.206.238.50:5000/edit_dieta/${correo}`, {
